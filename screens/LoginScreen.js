    ...
    <SafeAreaView>
      <LinearGradient
        ...
        <View style={styles.loginSec}>
          <Text style={styles.loginSecText}>Login</Text>
          <Formik
            ...
            {({handleChange, handleSubmit, values, errors, touched}) => (
              <>
                ...
                <View style={styles.remember_forget_Sec}>
                  <View style={styles.remember_Sec}>
                    <Checkbox
                      status={checked ? 'checked' : 'unchecked'}
                      onPress={handleCheckboxToggle}
                      style={styles.checkboxStyle}
                    />
                    <Text style={styles.remember_Text_Sec}>Remember me</Text>
                  </View>
                  <Text style={styles.loginPassword}>Forgot password?</Text>
                </View>
          ...
          <Text style={styles.loginSecContinue}>Or continue with</Text>
          <View style={styles.loginIcon}>
            <Text style={styles.loginSecIcon}>
              <FontAwesome name="facebook-f" size={25} color="#1773EA" />
            </Text>
            <Text style={styles.loginSecIcon}>
              <GoogleSVG />
            </Text>
